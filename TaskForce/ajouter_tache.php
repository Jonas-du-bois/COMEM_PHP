...
$statut = 'a_faire';  // Valeur par défaut si le formulaire n'a pas été soumis
...
// Récupérer tous les utilisateurs pour le select multiple
                ...
                <form method="POST" action="">
                    ...
                    <div class="row g-3 mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4" placeholder="Décrivez la tâche"><?php echo htmlspecialchars($description ?? ''); ?></textarea>
                        </div>
                    </div>
