...
echo '<a href="http://php.net/manual/fr/language.types.array.php">Documentation officielle sur les tableaux</a>','<br>';
...
$tabPersonne["chef"] = "M";
$tabPersonne[1] = "Spy"; // si on utilise un index c'est comme si c'était une clé "numérique" !
...
$matrice[2][0] = 100;
$matrice[2][1] = 200;
echo "\$matrice : ", var_dump($matrice), "<BR><BR>";
...
echo '<a href="https://www.php.net/manual/fr/ref.array.php">Documentation officielle sur les fonctions relatives aux tableaux</a>';
